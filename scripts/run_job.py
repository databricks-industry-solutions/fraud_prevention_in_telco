...
fraud_data_pipeline = Job.from_dict(
    {
        ...
        "tasks": [
            ...
            {"task_key": "Risk_Engine", "depends_on": [{"task_key": "Gold_Transactions"}], "spark_python_task": {"python_file": f"{REPO_ROOT}/notebooks/risk_engine.py"}, "environment_key": "fraud_data_pipeline_environment"},
