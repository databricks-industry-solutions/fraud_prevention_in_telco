...
import { fetchCaseDetail, fetchCustomerHistory, fetchDecisionHistory, submitAction, type CaseDetailData, type CustomerHistoryItem, type DecisionHistoryItem } from '../lib/api'
...
export default function CaseDetail() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setActionResult(`Decision recorded: ${res.decision_id}`)
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <section className="bg-[#161922] border border-gray-800 rounded-lg p-4">
            ...
            <dl className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              <Field label="Risk Reason" value={c.risk_reason_engine} />
